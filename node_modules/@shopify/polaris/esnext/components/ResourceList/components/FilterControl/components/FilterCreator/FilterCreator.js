...
export function FilterCreator({ filters, resourceName, disabled, onAddFilter, }) {
    ...
    return (<Popover active={popoverActive} activator={activator} onClose={togglePopoverActive} sectioned fullHeight>
      <Form onSubmit={handleAddFilter}>
        <FormLayout>
          <Select label={translate('Polaris.ResourceList.FilterCreator.showAllWhere', { resourceNamePlural: resourceName.plural.toLocaleLowerCase() })} placeholder={translate('Polaris.ResourceList.FilterCreator.selectFilterKeyPlaceholder')} options={filterOptions} onChange={handleFilterKeyChange} value={selectedFilter && selectedFilter.key}/>
