import React__default, { useContext, useState, useEffect, useCallback, useRef, createRef, useLayoutEffect, createContext, memo, Fragment, createElement } from 'react';
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '4.3.0';
}

var polarisVersion = '4.3.0';
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          id = _this$props2$id === void 0 ? getUniqueID$2() : _this$props2$id,
          label = _this$props2.label,
...
var getUniqueID$4 = createUniqueIDFactory('modal-header');
...
var getUniqueID$5 = createUniqueIDFactory('TooltipContent');
var Tooltip =
/*#__PURE__*/
function (_React$PureComponent) {
...
function Pagination(_ref) {
  ...
  var navLabel = accessibilityLabel || intl.translate('Polaris.Pagination.pagination');
...
function FilterCreator(_ref) {
  ...
  }, translate('Polaris.ResourceList.FilterCreator.addFilterButtonLabel')) : null;
  return React__default.createElement(Popover, {
    ...
    label: translate('Polaris.ResourceList.FilterCreator.showAllWhere', {
      resourceNamePlural: resourceName.plural.toLocaleLowerCase()
    }),
    placeholder: translate('Polaris.ResourceList.FilterCreator.selectFilterKeyPlaceholder'),
